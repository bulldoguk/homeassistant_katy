...
from zigpy.zcl.clusters.general import Basic, Identify, Ota, GreenPowerProxy, AnalogOutput, OnOff
...
from zhaquirks.tuya import TuyaLocalCluster, TuyaManufCluster, TuyaNewManufCluster, TuyaZBE000Cluster, NoManufacturerCluster
    ...
    attributes.update(
        {
            ...
            0xEF6C: ("static_disdtance", t.uint32_t, True),
